...
Current full-suite counts (`python -m pytest tests/g0/ -q` → **672 passed**, Book 3 in progress):
Book 0 = 51, Book 1 = 133, Book 2 = 255, Book 3 = 233 (C1-C26 implemented). Book 2 complete — Reality Lock PASS, ready_for_book3.
