...
Current full-suite counts (`python -m pytest tests/g0/ -q` → **682 passed**, Book 3 in progress):
Book 0 = 51, Book 1 = 133, Book 2 = 255, Book 3 = 243 (C1-C27 implemented, Reality Lock PASS, ready_for_book4). Book 2 complete — Reality Lock PASS, ready_for_book3.
