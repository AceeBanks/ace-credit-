...
Current full-suite counts (`python -m pytest tests/g0/ -q` → **1186 passed, 3 skipped**):
Book 0 = 51, Book 1 = 133, Book 2 = 255, Book 3 = 243, Book 4 = 276 (C1-C28, Reality Lock PASS), Book 5 = 228 (C1-C26, Reality Lock PASS). Books 2/3/4/5 complete — Reality Locks PASS.
