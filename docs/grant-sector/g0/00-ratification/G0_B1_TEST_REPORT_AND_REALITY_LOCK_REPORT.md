...
Current full-suite counts (`python -m pytest tests/g0/ -q` → **559 passed**, Book 3 in progress):
Book 0 = 51, Book 1 = 133, Book 2 = 255, Book 3 = 120 (C1-C17 implemented). Book 2 complete — Reality Lock PASS, ready_for_book3.
